...
#MODEL_NAME = "data/esm2/esm2_t36_3B_UR50D"
...
def get_esm_embedding(model, tokenizer, device, sequence):
    ...
    try:
        with torch.no_grad():
            ...
            last_layer_embedding = embeddings[0, 1:-1].float().cpu().numpy()
...
if __name__ == "__main__":
    ...
    output_file_path = './emb/esm2_15b.5120.lmdb'  # 请替换为您希望保存 LMDB 文件的路径
